  ...
  <div>
    ...
    <div class="flex gap-[20px]">
      <div class="w-full">
        <Textarea
          class="mt-4"
          placeholder="Birinchi text"
          v-model="form.firstText"
        />
        <Textarea
          class="mt-4"
          placeholder="Ikkinchi text"
          v-model="form.secondText"
        />
      </div>
      <div class="w-full">
        <Textarea
          class="mt-4"
          placeholder="Uchinchi text"
          v-model="form.thirdText"
        />
        <UploadImages class="w-full" @upload="getImages" />
      </div>
    </div>
    <SButton variant="info" class="ml-auto w-[300px] mt-5" @click="onSubmit"
      >Saqlash</SButton
    >
  </div>
</template>
