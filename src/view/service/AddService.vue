        ...
        <p class="py-2 px-3 font-medium">Tahrirlash:</p>
         ...
         <div class="px-4 py-2 text-center w-full">
          <form class="border mb-4">
            <textarea type="text" class="w-full  h-[80px] outline-none p-2 resize-none" v-model="editServiceText"></textarea>
          </form>
          <div class="flex justify-end">
           <button id="cancel" @click="cancelModal"
             class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
             Bekor qilish
           </button>
           <button id="agree" @click="editModal"
    ...
    <input
        ...
        <div class="w-full my-4">
          <form class="w-full" @submit="addService">
            <input type="text" v-model="service" class="w-full rounded-md h-[40px] px-4 outline-none" placeholder="Service qo'shish">
          </form>
